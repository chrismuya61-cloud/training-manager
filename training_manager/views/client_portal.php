...
<div class="hero">
    <div class="main-container">
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="portal-logo"><a href="<?php echo site_url(); ?>"><?php echo get_company_logo(base_url('uploads/company/'), 'img-responsive'); ?></a></div>
                ...
                <div class="content-card mb-4">
                    ...
                    <?php } else { ?>
                        <?php echo form_open('training_manager/client/submit_feedback'); ?>
                            ...
                            <textarea name="comment" class="form-control mb-3" placeholder="Share your experience..."></textarea>
